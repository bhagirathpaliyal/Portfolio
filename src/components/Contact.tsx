...
const Contact = () => {
  return (
    <div  id="section4" className='section4 flex flex-col items-center md:py-[100px] py-[50px]s animate-[appear1_linear] animationTimeline'>
    ...
    <a href="mailto:bhagirathpaliyal@gmail.com"> <div className='flex md:m-[16px] gap-[5px] justify-center items-center'>
