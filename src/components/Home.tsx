...
const Home = () => {
  return (
    <div className='h-[100vh] flex justify-center items-center gap-[100px]'>

        <img src="../../public/assets/MyImg.jpg" className='h-[340px] rounded-[50%]' alt="profile photo" />
        <div>
            <p className='text-[16px] text-[#555555] text-center font-medium'>Hello, I'm</p>
           <h1 className='text-[48px] text-[#000000] font-bold text-center'>Bhagirath Paliyal</h1>
            <p className='text-[28px] text-[#555555] text-center font-medium'>Frontend Developer</p>
