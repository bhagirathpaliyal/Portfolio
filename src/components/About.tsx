...
const About = () => {
  return (
    <div className='flex flex-col items-center my-[50px]'>
      ...
      <h2 className='text-[48px] font-bold'>About Me</h2>
      <div>
        <div>
          <div className='flex justify-around my-[30px]'>
            <div className=' border flex flex-col justify-center items-center rounded-[30px] p-[20px]'>
              ...
              <p className='text-[16px]'>Sahid Gangaram GSS School Dhandhaniya,Jodhpur</p>
            ...
            <div className=' border flex flex-col justify-center items-center rounded-[30px] p-[20px]'>
              ...
              <p className='text-[16px]'>Vardhman Mahaveer Open University, Kota</p>
              
            </div>
          </div>
          <p>I have a strong understanding of HTML, CSS, and JavaScript, and I am proficient in using react js
