      ...
      <div>
        <div>
          <div className="flex max-md:flex-col max-md:gap-[20px] justify-around my-[30px]">
            <div className=" border flex flex-col justify-center items-center rounded-[30px] p-[20px]">
              ...
              <p className="text-[16px] text-center">
                Sahid Gangaram GSS School Dhandhaniya,Jodhpur
              </p>
            </div>
            <div className=" border flex flex-col justify-center items-center rounded-[30px] p-[20px]">
              <img
          ...
          <p className="text-center">
            ...
            proficient in using react js I am able to create user interfaces
            that are both visually appealing and user-friendly. I am able to
            work independently and as part of a team, and I am always willing to
            go the extra mile to meet deadlines and exceed expectations. I am
            confident that I can provide you with the high-quality front-end
            development services that you need to succeed.
          </p>
        </div>
      </div>
    </div>
